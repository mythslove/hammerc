...
package org.hammerc.themes.hi.controls.scrollClasses
{
	 ...
	 * @author wizardc
	 */
	public class HiScrollBarDownButtonSkin extends AbstractSimplestButtonSkin
	{
		/**
		 * 记录按钮的状态.
		 */
		...
		/**
		 * 创建一个 <code>HiScrollBarDownButtonSkin</code> 对象.
		 * @param owner 该皮肤对象对应的组件.
		 */
		public function HiScrollBarDownButtonSkin(owner:IUIComponent)
		{
			super(owner);
		}
		...
		override protected function addChildren():void
		{
			...
			_arrow.graphics.moveTo(2, 3);
			_arrow.graphics.lineTo(4, 0);
