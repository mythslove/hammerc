...
package org.hammerc.themes.hi.containers
{
	...
	/**
	 * <code>HiPanelSkin</code> 类定义了 Hi 主题的面板皮肤.
	 * @author wizardc
	 */
	public class HiPanelSkin extends AbstractPanelSkin
	{
		/**
		 * 创建一个 <code>HiPanelSkin</code> 对象.
		 * @param owner 该皮肤对象对应的组件.
		 */
		public function HiPanelSkin(owner:IUIComponent)
		{
			super(owner);
		}
