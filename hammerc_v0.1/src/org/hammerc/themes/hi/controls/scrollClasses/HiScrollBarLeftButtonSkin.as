...
package org.hammerc.themes.hi.controls.scrollClasses
{
	 ...
	 * @author wizardc
	 */
	public class HiScrollBarLeftButtonSkin extends AbstractSimplestButtonSkin
	{
		/**
		 * 记录按钮的状态.
		 */
		...
		/**
		 * 创建一个 <code>HiScrollBarLeftButtonSkin</code> 对象.
		 * @param owner 该皮肤对象对应的组件.
		 */
		public function HiScrollBarLeftButtonSkin(owner:IUIComponent)
		{
			super(owner);
		}
		...
		override protected function addChildren():void
		{
			...
			_arrow.graphics.moveTo(0, 2);
			_arrow.graphics.lineTo(3, 4);
			_arrow.graphics.lineTo(3, 0);
