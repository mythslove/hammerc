...
package org.hammerc.themes.hi.controls.scrollClasses
{
	 ...
	 * @author wizardc
	 */
	public class HiScrollBarUpButtonSkin extends AbstractSimplestButtonSkin
	{
		/**
		 * 记录按钮的状态.
		 */
		...
		/**
		 * 创建一个 <code>HiScrollBarUpButtonSkin</code> 对象.
		 * @param owner 该皮肤对象对应的组件.
		 */
		public function HiScrollBarUpButtonSkin(owner:IUIComponent)
		{
			super(owner);
		}
		...
		override protected function addChildren():void
		{
			...
			_arrow.graphics.moveTo(2, 0);
			_arrow.graphics.lineTo(4, 3);
			_arrow.graphics.lineTo(0, 3);
