...
package org.hammerc.themes.hi.controls
{
	...
	import org.hammerc.skin.controls.AbstractCheckBoxSkin;
	import org.hammerc.themes.hi.HiThemeStyle;
	
	/**
	 * <code>HiCheckBoxSkin</code> 类定义了 Hi 主题复选框皮肤.
	 * @author wizardc
	 */
	public class HiCheckBoxSkin extends AbstractCheckBoxSkin
	{
		/**
		 * 绘制左侧的小格子.
		 */
		...
		/**
		 * 创建一个 <code>HiCheckBoxSkin</code> 对象.
		 * @param owner 该皮肤对象对应的组件.
		 */
		public function HiCheckBoxSkin(owner:IUIComponent)
		{
			super(owner);
		}
		...
		override protected function addChildren():void
		{
			...
			_box.graphics.drawRect(0, 0, 12, 12);
			...
			_square.graphics.drawRect(1, 1, 6, 6);
			_square.graphics.endFill();
			_square.graphics.beginFill(HiThemeStyle.BUTTON_FACE);
			_square.graphics.drawRect(0, 0, 6, 6);
			_square.graphics.endFill();
