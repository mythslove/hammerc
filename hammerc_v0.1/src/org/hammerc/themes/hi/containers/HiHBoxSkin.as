...
package org.hammerc.themes.hi.containers
{
	...
	/**
	 * <code>HiHBoxSkin</code> 类定义了 Hi 主题的水平排列容器皮肤.
	 * @author wizardc
	 */
	public class HiHBoxSkin extends AbstractHBoxSkin
	{
		/**
		 * 创建一个 <code>HiHBoxSkin</code> 对象.
		 * @param owner 该皮肤对象对应的组件.
		 */
		public function HiHBoxSkin(owner:IUIComponent)
		{
			super(owner);
		}
